...
Version  : 0.16
Release  : 31
URL      : https://cpan.metacpan.org/authors/id/O/OV/OVID/Role-Basic-0.16.tar.gz
Source0  : https://cpan.metacpan.org/authors/id/O/OV/OVID/Role-Basic-0.16.tar.gz
...
%prep
%setup -q -n Role-Basic-0.16
cd %{_builddir}
tar xf %{_sourcedir}/librole-basic-perl_0.13-2.debian.tar.xz
cd %{_builddir}/Role-Basic-0.16
mkdir -p deblicense/
cp -r %{_builddir}/debian/. %{_builddir}/Role-Basic-0.16/deblicense/
