...
cd ..
%setup -q -T -D -n Role-Basic-0.13 -b 1
mkdir -p deblicense/
cp -r %{_topdir}/BUILD/debian/* %{_topdir}/BUILD/Role-Basic-0.13/deblicense/
...
%files
%defattr(-,root,root,-)
/usr/lib/perl5/vendor_perl/5.28.2/Role/Basic.pm
/usr/lib/perl5/vendor_perl/5.28.2/Role/Basic/Philosophy.pod
